...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230812034731_UpdatedEventParticipant")]
    partial class UpdatedEventParticipant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DbEntities.EventParticipants.EventParticipant", b =>
                {
                    b.HasOne("Domain.DbEntities.Event.Events", "Event")
                        .WithMany("User")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.DbEntities.User.Users", "User")
